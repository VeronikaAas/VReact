                    ...
                    <div className="flex flex-col justify-between items-center md:items-start text-center md:text-left w-full h-full">
                        ...
                        <div className="mt-4 sm:mt-6 flex flex-col gap-3 w-full">
                            ...
                            <Link to="/" className="w-full">
                                <button aria-label="Back to Homepage" className="w-full h-[48px] bg-yellow-500 text-white text-sm sm:text-base rounded-lg hover:bg-yellow-800 font-bold flex items-center justify-center">
                                    Back to homepage
                                </button>
                            </Link>
                        </div>
