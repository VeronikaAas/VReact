...
const CheckoutPage = () => {
    ...
    const totalPrice = parseFloat(
        groupedCart.reduce((sum, item) => sum + (item.discountedPrice && item.discountedPrice < item.price 
                    ...
                    <div>
                        <ul>
                            {groupedCart.map((item) => (
                                <li key={item.id} className="border p-4 mb-4 flex flex-col sm:flex-row justify-between items-center bg-gray-50 rounded-lg shadow-sm">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-2 sm:space-y-0 sm:space-x-2">
                                        <div className="flex items-center">
                                            <button aria-label="Reduce item by one"
                        ...
                        <button aria-label="Ready to pay"
